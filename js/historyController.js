...
app.controller('FactureALL', function($scope, $compile) {
    ...
    supplyInvoicesTable=$('#supplyInvoicesTable').DataTable({
        ...
        columns: [
            ...
            "render": function (data,meta,row) {
             return '<input ng-click="showSupplyDetailDialog('+data+')" id="showDetails" type="button" class="glyphicon btn-info btn" value="&#xf044" title="تعديل"/> ';}}
    ...
    sellsTable=$('#sellsTable').DataTable({
        ...
        columns: [
            ...
            "sortable": false,
            "render": function (data,meta,row) {
             return '<input ng-click="showSellsDetailDialog('+data+')" id="showSellsDetails" type="button" class="glyphicon btn-info btn" value="&#xf044" title="تعديل"/> ';}}
